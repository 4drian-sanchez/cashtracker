...
import { expenseBelongToBudget, validateExpenseExists, validateExpenseId, validateExpensesInput } from "../middlewares/expenses";
...
router.param('expenseId', expenseBelongToBudget) //req.expenses
